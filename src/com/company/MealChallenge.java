...
//              create an integer called "totalCost" and initialize it to "(int)Math.round(mealCost+tip+tax)"- which basically is the tip, tax, and meal cost added together, rounded and converted into an integer(gives you total cost of meal including tax and tip)
